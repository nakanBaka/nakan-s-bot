...
exports.run = (client,message,args)=> {
    ...
    if (channels.includes(message.channel.id)) {
        message.reply("Tente novamente mais tarde!");
        return;
    }
    var size;
    if (+args[0] >= 5 && +args[0] <= 50) {
        ...
        message.reply("Escolha um número entre 5 e 50!");
        return;
    }
...
class Drawing {
    constructor(msg, size, fg, bg) {
        ...
        msg.edit("Use as reações para desenhar :\n✅ Parar de desenhar | 🖋 caneta ativa | 🔏 caneta desativada");
        this.reactArrows(0);
    ...
    stop(reason = "") {
        ...
        this.msg.edit("Seu desenho:" + reason);
    ...
    renewTimeout() {
        ...
        this.timeout = this.msg.client.setTimeout(function() {
            self.stop("\Terminou em (2 minutos)");
        }, 120000);
    }
